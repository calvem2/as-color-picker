 ...
 *
 * An almost identical non-static version of this class is edited from
...
public class ColorNames {
     ...
     * @return
     */
    public static String GetColorName(float r, float g, float b) {
     ...
     * @return
     */
    public static String GetColorName(int hexColor) {
